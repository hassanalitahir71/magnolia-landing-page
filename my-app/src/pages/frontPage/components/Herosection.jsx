...
const Herosection = () => {
  return (
    <div className="h-100 w-[95%] gap-11 justify-between  flex flex-row">
      <div className="h-full w-[60%] flex flex-col  ">
        <div className=" flex flex-col gap-5">
          <h1 className="text-5xl mt-8 ml-20 w-120 font-bold">
            Visit the Most{" "}
          ...
          <div className="flex flex-row justify-center items-center border-r border-gray  gap-9">
            ...
            <div>
              ...
              <div className="flex flex-row justify-center items-center gap-1">
                ...
                <div className="flex flex-row justify-center items-center mr-5 gap-13">
                  <h4>5 Days</h4>
                  <FaChevronDown />
                </div>
              </div>
          ...
          <div className=" flex  flex-row ml-5 gap-4">
            <div className="flex flex-col">
              ...
              <div className="flex flex-row justify-center items-center gap-1">
                ...
                <div className="flex flex-row justify-center items-center mr-7 gap-2">
                  <h4>17 July 2021</h4>
                  <FaChevronDown />
                </div>
              </div>
      ...
      <img className="h-full w-[40%]" src={contentpic} alt="" />
    </div>
  );
};
